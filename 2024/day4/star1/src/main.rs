...
impl Data {
    fn vertical(&self, x:usize, y:usize) -> i32 {
        ...
        if (self.line.len()-1 ) - y >= 3 {
            if self.line[y][x] == 'X' as u8 && self.line[y+1][x] == 'M' as u8 && self.line[y+2][x] == 'A' as u8  &&  self.line[y+3][x] == 'S' as u8 { 
                 num_xmas += 1;
    ...
    fn horizontal(&self, x:usize, y:usize) -> i32 {
        ...
        // is there space for xmas?
        if x+3 < self.xlen {
            if self.line[y][x] == 'X' as u8 && self.line[y][x + 1] == 'M' as u8 && self.line[y][x + 2] == 'A' as u8  &&  self.line[y][x + 3] == 'S' as u8 { 
                 num_xmas += 1;
    ...
    fn diagonal(&self, x:usize, y:usize) -> i32 {
        ...
        if x+3 < self.xlen  && y >= 3 {
            if self.line[y][x] == 'X' as u8 && self.line[y-1][x +1] == 'M' as u8 && self.line[y-2][x + 2] == 'A' as u8  &&  self.line[y-3][x + 3] == 'S' as u8 { 
                 num_xmas += 1;
                 println!("diagonal at {} x {}", x, y);

            }  
        }
        // is there space for upwards xmas to the left?
        // S
        //   A 
        //     M 
        //       X 
        ...
        // is there space for downwards xmas to the left?
        //
        //----------------------
        //  X 
        //   M 
        ...
        // is there space for downwards xmas to the right?
        //         X 
        //       M 
        //     A 
        //   S 
